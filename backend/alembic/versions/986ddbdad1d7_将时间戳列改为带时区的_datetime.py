...
def upgrade() -> None:
    ...
    op.drop_table('_alembic_tmp_campaign_contacts')
...
def downgrade() -> None:
    ...
    op.create_table('_alembic_tmp_campaign_contacts',
    ...
    sa.Column('added_by', sa.VARCHAR(length=50), server_default=sa.text("'manual'"), nullable=False),
